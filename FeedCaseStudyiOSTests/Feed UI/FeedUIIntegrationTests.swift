...
final class FeedUIIntegrationTests: XCTestCase {
    ...
    func test_feedImageViewLoadingIndicator_isVisibleWhileLoadingImage() {
        ...
        XCTAssertEqual(view0?.isShowingImageLoadingIndicator, false, "Expected no loading indicator once first image loading completes successfully")
    ...
    func test_feedImageView_cancelsImageURLPreloadingWhenNotNearVisibleAnymore() {
        ...
        XCTAssertEqual(loader.cancelledImageURLs, [image0.url], "Expected cancelled first image URL request once first image is not near visible")
        
        sut.simulateFeedImageViewNotNearVisible(at: 1)
        XCTAssertEqual(loader.cancelledImageURLs, [image0.url, image1.url], "Expected cancelled second image URL request once second image is not near visible")
    }
    ...
    func test_loadFeedCompletion_dispatchesFromBackgroundToMainThread() {
        ...
        let exp = expectation(description: "Wait for background queue completion")
